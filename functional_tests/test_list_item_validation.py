...
class ItemValidationTest(FunctionalTest):
    ...
    def test_cannot_add_empty_list_items(self):
        ...
        self.browser.find_element(By.ID, 'id_new_item').send_keys('Look for fish')
        self.browser.find_element(By.ID, 'id_new_item').send_keys(Keys.ENTER)
        ...
        self.browser.find_element(By.ID, 'id_new_item').send_keys('Try to catch fish without getting wet')
        self.browser.find_element(By.ID, 'id_new_item').send_keys(Keys.ENTER)
        self.wait_for_row_in_list_table('1: Look for fish')
